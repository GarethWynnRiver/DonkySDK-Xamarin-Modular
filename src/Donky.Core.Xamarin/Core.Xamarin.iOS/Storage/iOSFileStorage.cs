// ///////////////////////////////////////////////////////////////////////////////////////////
//  Description:     iOSFileStorage class
//  Author:          Ben Moore
...
{
	/// <summary>
	/// iOS implementation of file storage
	/// </summary>
	public class iOSFileStorage : IFileStorage
	{
		private readonly IsolatedStorageFile _storage;
		private readonly string _directory;

		public iOSFileStorage(IsolatedStorageFile storage, string directory)
		{
			_storage = storage;
